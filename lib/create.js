...
/**
 * Create xmlbuilderNodes for specified node with specified input
 * @param  {xmlbuilderNode} parentNode xmlbuilder node which will receive new nodes
 * @param  {object}         input      Complex object with specific shape to be converted to YML object
 *                                     @link lib/schemas.js/DeliveryOptionsSchema
 * @return {xmlbuilderNode} `parentNode` with newly created nodes based on input
 */
 ...
 * @param  {xmlbuilderNode} parentNode xmlbuilder node which will receive new nodes
 * @param  {object}         input      Complex object with specific shape to be converted to YML object
 *                                     @link lib/schemas.js/OffersSchema
 * @return {xmlbuilderNode} `parentNode` with newly created nodes based on input
 */
