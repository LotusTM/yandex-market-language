...
const r = require('../tests/utils/tcomb')
...
const DeliveryOptions = r.Maxlength(5)(t.list(t.struct({
  cost: t.Integer,
...
const Currencies = t.list(t.struct({
  id: CurrencyId,
...
const Categories = t.list(t.struct({
...
const Offer = (o) => {
  ...
  if (o.type || o.typePrefix) return FreeOffer(o)
  return SimplifiedOffer(o)
}

const Offers = t.list(Offer, 'YML Offers')
